...
rDY[2] = nass + dt * dnass;
real dki = -(ICaK_i+Ito+IKr+IKs+IK1+IKb+IKatp+Istim-2.0*INaK+IKCa_i)*Acap/(F*vmyo)+JdiffK*vss/vmyo;
rDY[3] = ki + dt * dki;
real dkss = -(ICaK_ss+IKCa_ss)*Acap/(F*vss)-JdiffK;
rDY[4] = kss + dt * dkss;
